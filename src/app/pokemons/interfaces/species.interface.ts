// To parse this data:
//
//   import { Convert, SpeciesPokemon } from "./file";
//
//   const speciesPokemon = Convert.toSpeciesPokemon(json);
//
...
export class Convert {
    public static toSpeciesPokemon(json: string): SpeciesPokemon {
        return cast(JSON.parse(json), r("SpeciesPokemon"));
    }

    public static speciesPokemonToJson(value: SpeciesPokemon): string {
        return JSON.stringify(uncast(value, r("SpeciesPokemon")), null, 2);
    }
}
